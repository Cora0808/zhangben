...
const INCS=[
  ...
  {k:'bonus',n:'奖金'},{k:'reimb',n:'报销到账'},{k:'other',n:'其他收入'}
];
/* 理财/存储账户 */
const ACCS=[
...
function renderInvest(){
  ...
  let h='';
  h+='<div class="card cy-b"><div class="c-head"><div class="c-title">PORTFOLIO / 持仓</div><div class="c-sub">'+mLabel(ym)+' 投入 ¥'+fmt(mIn)+'</div></div>';
  /* 余利宝 */
